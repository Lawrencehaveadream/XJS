...
namespace UI
{
    public partial class Frm_TwoPArray :Form
    {
        ...
        {
            numericUpDown1.Value = (decimal)AxisPosCurr[0];
            numericUpDown2.Value = (decimal)AxisPosCurr[1];
            numericUpDown3.Value = (decimal)AxisPosCurr[2];
        }

        private void btn_TwoArrayreadp2_Click(object sender, EventArgs e)
        {
            numericUpDown4.Value = (decimal)AxisPosCurr[0];
            numericUpDown5.Value = (decimal)AxisPosCurr[1];
            numericUpDown6.Value = (decimal)AxisPosCurr[2];
        }
        #endregion
