...
namespace HZZH.UI.DerivedControl
{
    public partial class Frm_MotorParam : Form
    {
        ...
        private void LoadtreeView1(List<AxisClass> list)
        {
            ...
            {
                count++;
                this.treeView1.Nodes.Add(new TreeNode(p.AxisName));
            }
        }
        ...
        private void btn_JogAxisPos_MouseDown(object sender, MouseEventArgs e)
        {
            ...
            _speed = (float)(skinTrackBar1.Value/100) * this.axis.currSpd;
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            Functions.SetBinding(Nud_DAch1, "Value", DAch1, "value");
            Functions.SetBinding(Nud_DAch2, "Value", DAch2, "value");
        }
        ...
        private void treeView1_AfterSelect(object sender, TreeViewEventArgs e)
        {
            ...
            propertyGrid1.SelectedObject = axis.GetAxisConfigParaDef;
