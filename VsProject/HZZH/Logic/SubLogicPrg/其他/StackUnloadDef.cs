...
{
	public class StackUnloadDef : LogicTask
	{
		...
		public StackUnloadDef() : base("下料堆叠下一层") { }
		protected override void LogicImpl()
		{
			...
			{
				case 1:
					if (!DeviceRsDef.Ax_UnloadZ.busy)
					{
						DeviceRsDef.Ax_UnloadZ.MC_MoveAbs(Pos_First + CurIdx * (Pos_Last - Pos_First) / (Num_Level - 1));
						LG.StepNext(2);
					}
					break;
